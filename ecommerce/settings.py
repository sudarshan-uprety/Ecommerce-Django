...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "https://pbs.twimg.com/media/FutpaMIacAAhOjN?format=png&name=small",

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": 'https://images.unsplash.com/photo-1575936123452-b67c3203c357?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aW1hZ2V8ZW58MHx8MHx8fDA%3D&w=1000&q=80',

    # Logo to use for login form in dark themes (defaults to login_logo)
    "login_logo_dark": None,

    # CSS classes that are applied to the logo above
    "site_logo_classes": "https://pbs.twimg.com/media/FutpaMIacAAhOjN?format=png&name=small",
